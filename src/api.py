...
class ChatRequest(BaseModel):
    ...
    customer_id: int = 1  # Default customer for demo
...
def check_pending_approval(thread_id: str, customer_id: int) -> tuple[bool, Optional[str]]:
...
def get_thread_status(thread_id: str, customer_id: int = 1):
    ...
    if thread_id in rejected_responses:
        ...
        return {
            "status": "completed",
            "message": rejected_responses[thread_id]
        }
