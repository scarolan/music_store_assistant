...
from src.api import app, pending_approvals, rejected_responses, graph
...
class TestHITLFlow:
    ...
    def test_refund_request_triggers_hitl(self, client):
        ...
        data = r2.json()
        assert data["requires_approval"] == True, "Refund confirmation should require approval"
    ...
    def test_approve_endpoint_works(self, client):
        ...
        assert r2.json()["requires_approval"] == True
...
class TestStatusEndpoint:
    ...
    def test_status_completed_after_rejection(self, client):
        ...
        # Reject
        client.post(f"/reject/{thread_id}?customer_id=1")
