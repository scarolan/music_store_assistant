...
def test_get_customer_info_exists():
...
def test_process_refund_exists():
...
def test_all_support_tools_are_langchain_tools():
...
def test_process_refund_has_meaningful_docstring():
...
def test_get_customer_info_returns_customer_data():
...
@pytest.mark.integration
def test_get_invoice_returns_invoice_data():
